...
### Installing Splunk
﻿A new Splunk installation requires configuration to set up the application, as well as tune it to the environment. This section of the module covers how to install and configure Splunk.
﻿
